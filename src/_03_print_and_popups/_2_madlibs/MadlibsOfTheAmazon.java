...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adj = JOptionPane.showInputDialog("ADJ Pls");
		// Get the player to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("liquid Pls");
		// Get the player to enter a body part
		String bodypart = JOptionPane.showInputDialog("body part Pls");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog("verb Pls");
		// Get the player to enter a place
		String place = JOptionPane.showInputDialog("place Pls");
